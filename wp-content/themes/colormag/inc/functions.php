...
function colormag_scripts_styles_method() {
	 ...
	 */
	 /* coolbird bootstrap*/
	wp_enqueue_style( 'coolbird_bootstrap',get_template_directory_uri().'/css/bootstrap.min.css',array(),'4.0.0');
	wp_register_script( 'coolbird_bootstrap',get_template_directory_uri().'/js/bootstrap.bundle.min.js',array(),'4.0.0');
	...
	/**
	 * coolbird bxslider css
	 */
	 wp_enqueue_style( 'coolbird_bxslider',get_template_directory_uri().'/css/jquery.bxslider.css',array(),'4.2.12');
	/**
	 ...
	 */
	wp_register_script( 'colormag-bxslider', COLORMAG_JS_URL . '/jquery.bxslider.min.js', array( 'jquery' ), '4.2.12', true );
