...
if ( is_single() ) {
	...
	?>
		<ul class="default-wp-page clearfix">
			<li class="previous"><?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'colormag' ) . '</span>Xem <strong>%title</strong>' ); ?></li>
			<li class="next"><?php next_post_link( '%link', 'Xem <strong>%title</strong> <span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'colormag' ) . '</span>' ); ?></li>
		</ul>
	<?php
	}
}
